...
return {
    {
        ...
        config = function()
            ...
            vim.cmd("hi Normal guibg=" .. background)                        -- Darkk gray background
            ...
            vim.cmd("hi CursorLine guibg=" .. background)                    -- Dark gray background for cursor line:w
            ...
            vim.cmd("hi CursorLineNr guifg=#508020 gui=bold") -- Cursor line color
            vim.cmd("set cursorline") -- Enable Cursor line

            vim.o.colorcolumn = "72,80,90" -- Highlights columns 72, 80, and 100
